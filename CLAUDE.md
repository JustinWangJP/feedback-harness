...
- shell と Python の境界の性質(改行・encoding)は、経路ごとの場当たり処理ではなく一箇所の契約として書き、走査テストで書き戻しを止める。経路ごとに防御を足すと、抜けた経路だけが静かに壊れる(2026-08-23 のPR #13レビュー由来)。
